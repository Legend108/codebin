...
export default function Create({ user }: Props) {
  ...
  async function sendRequest(name: any, desc: any, snipp: any): Promise<string> {
    ...
    <>
      <Box bg={useColorModeValue("gray.100", "gray.900")} px={4}>
        <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
          <Box style={{fontSize: "30px;"}}>CodeBin</Box>
      ...
      {sent && (
        <>
          <Box textAlign="center" py={10} px={6}>
            ...
            <Text color={"gray.500"}>You will get redirected to you new snip automatically.</Text>
          </Box>
        </>
      )}
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              >
                ...
                >
                  ...
                  <Tooltip label={"Github for this app"}>
                    <Link href="#">
                      <IconButton
                        aria-label="github"
                        variant="ghost"
                ...
                >
                  <VStack spacing={5}>
                    ...
                    id="submit-btn"
                      onClick={async() => {
                        const thisBtn = document.getElementById("submit-btn")
                        // @ts-ignore
                        thisBtn?.innerHTML = "Submitting";
                        thisBtn?.setAttribute("isLoading", "true");
                        const snippet =
                        ...
                        const ID = await sendRequest(name, description, snippet);

                        redirect(ID); 
                        
                        thisBtn?.innerHTML = "Redirecting..");
                      }}
                    >
                      Send Message
                    </Button>
